      ...
      >
        <div className="lg:flex xl:block xl:overflow-y-auto">
          ...
          <>
            ...
            <span role="checkbox" tabIndex={0} aria-checked="false" className="relative inline-flex flex-shrink-0 h-6 w-11 border-2 border-transparent rounded-full cursor-pointer transition-colors ease-in-out duration-200 focus:outline-none focus:shadow-outline">
          ...
          <label className="text-gray-400 text-sm font-semibold py-1 block w-1/2 sm:w-1/4 lg:w-1/2">Immobilienart</label>  
          <div class="menu-slider-container" style={{ display: "flex", width: "auto", padding: "0.1rem", backgroundColor: "#ed8936", borderRadius: "6rem", maxWidth: "18rem", position: "relative" }}>
            <button class="aktiv menu-slider-icon" style={{ border: "none", background: "transparent", position: "relative", zIndex: 2, width: "5rem", height: "3rem", borderRadius: "5rem", cursor: "pointer", transition: "all 250ms", margin: "0 1rem 0 0" }}>
                <img class="aktiv h-5 w-5" style={{ opacity: 1, transform: "translate(150%, 40%) scale(1.2)" }} src="./pictures/icons/house.svg"/>
                <img class="normal h-5 w-5" style={{ opacity: 0 }} src="./pictures/icons/house.svg"/>
            </button>
            <button class="menu-slider-icon" style={{ border: "none", background: "transparent", position: "relative", zIndex: 2, width: "5rem", height: "3rem", borderRadius: "5rem", cursor: "pointer", transition: "all 250ms", margin: "0 1rem 0 0" }}>
            <img class="aktiv h-5 w-5" style={{ opacity: 1, transform: "translate(150%, 55%) scale(1.7)" }} src="./pictures/icons/couch.svg"/>
                <img class="normal h-5 w-5" style={{ opacity: 0 }} src="./pictures/icons/couch.svg"/>
            </button>
            <button class="menu-slider-icon" style={{ border: "none", background: "transparent", position: "relative", zIndex: 2, width: "5rem", height: "3rem", borderRadius: "5rem", cursor: "pointer", transition: "all 250ms", margin: "0 1rem 0 0" }}>
