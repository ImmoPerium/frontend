        ...
        <div className="mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8">
            ...
            <div className="grid grid-cols-2 gap-8 xl:col-span-2">
              ...
              <div className="md:grid md:grid-cols-2 md:gap-8">
                <div>
                  ...
                  <ul className="mt-4 space-y-4">
                  <li>
                    <a href="mailto:gregor.jaap@stud.leuphana.de" className="text-base leading-6 text-gray-300 hover:text-white">
                      Kontakt & Hilfe
                    </a>
                  </li>
                  </ul>
          ...
          <div className="mt-8 border-t border-gray-700 pt-8 md:flex md:items-center md:justify-between">
            <div className="flex space-x-6 md:order-2">
              ...
              <a href="https://app.pitch.com/app/public/presentation/d1bafd30-8993-414a-a6ee-4630b0d66dec/edecb258-7a86-4514-a9bc-a3dbab4c5b92" className="text-gray-400 hover:text-gray-300">
                <span className="sr-only">Pitch</span>
                <svg className="h-6 w-6" viewBox="0 0 321 111" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <path fillRule="evenodd" clipRule="evenodd" d="M0 108H18V87H34.5C58.5244 87 78 67.5244 78 43.5C78 19.4756 58.5244 0 34.5 0H0V108ZM18 18H34.5C48.5833 18 60 29.4167 60 43.5C60 57.5833 48.5833 69 34.5 69H18V18Z"/>
                </svg>
              </a>
              <a href="https://github.com/ImmoPerium" target="_blank" className="text-gray-400 hover:text-gray-300">
              ...
              <a href="https://www.figma.com/proto/JAtAYd3JApkjMY6ZtQZSsi/Immoperium?node-id=143%3A10&scaling=min-zoom" className="text-gray-400 hover:text-gray-300">
                <span className="sr-only">Figma</span>
                <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 50 65"><path d="M19 28.5a9.5 9.5 0 1 1 19 0 9.5 9.5 0 0 1-19 0z"></path><path d="M0 47.5A9.5 9.5 0 0 1 9.5 38H19v9.5a9.5 9.5 0 1 1-19 0z"></path><path d="M19 0v19h9.5a9.5 9.5 0 1 0 0-19H19z"></path><path d="M0 9.5A9.5 9.5 0 0 0 9.5 19H19V0H9.5A9.5 9.5 0 0 0 0 9.5z"></path><path d="M0 28.5A9.5 9.5 0 0 0 9.5 38H19V19H9.5A9.5 9.5 0 0 0 0 28.5z"></path></svg>
              </a>
            </div>
