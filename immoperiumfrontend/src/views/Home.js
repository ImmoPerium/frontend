...
export default class Home extends React.Component {
  ...
  dynamicSearch = () => {
    return this.state.location.filter(location => location.toLowerCase().includes(this.state.searchTerm.toLowerCase()))
  }
    ...
    return (
      <div>   
        <div className="relative">
          <Searchbar/>
          <img src="./pictures/landing-bg2.jpg" className="object-cover bg-center max-w-screen z-0"/>
        </div>
      </div>
    );
  }
