                      ...
                      <div className="col-span-3 sm:col-span-2">
                        ...
                        <div className="mt-1 flex rounded-md shadow-sm">
                          <input
                            ...
                            id="company_website"
                            className="outline-none focus:outline-none border-2 border-orange-200 focus:border-orange-500 flex-1 block w-full rounded-none rounded-r-md sm:text-"
                    ...
                    <div>
                      ...
                      <div className="mt-1">
                        <textarea
                          ...
                          name="about"
                          rows={3}
                          className="shadow-sm outline-none focus:outline-none border-2 border-orange-200 focus:border-orange-500 mt-1 block w-full sm:text-sm rounded-md"
                    ...
                    <div className="grid grid-cols-6 gap-6">
                      ...
                      <div className="col-span-6 sm:col-span-3">
                        ...
                        <input
                          ...
                          id="first_name"
                          autoComplete="given-name"
                          className="mt-1 outline-none focus:outline-none border-2 border-orange-200 focus:border-orange-500 block w-full py-1 shadow-sm sm:text-sm rounded-md"
                        />
                      </div>
                      <div className="col-span-6 sm:col-span-3">
                        <label
                        ...
                        <input
                          ...
                          id="last_name"
                          autoComplete="family-name"
                          className="mt-1 outline-none focus:outline-none border-2 border-orange-200 focus:border-orange-500 block w-16 py-1 shadow-sm sm:text-sm rounded-md"
                        />
                      </div>
                      ...
                      <div className="col-span-6 sm:col-span-3 lg:col-span-2">
                        ...
                        <input
                          ...
                          className="mt-1 outline-none focus:outline-none border-2 border-orange-200 focus:border-orange-500 block w-20 py-1 shadow-sm sm:text-sm rounded-md"
                        />
                      </div>
                      <div className="col-span-6 sm:col-span-3">
                        <label
